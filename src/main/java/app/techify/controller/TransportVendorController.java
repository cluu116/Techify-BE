    ...
    public class TransportVendorController {
        ...
        @PostMapping("")
        public ResponseEntity<TransportVendor> createTransportVendor(@Valid @RequestBody TransportVendorDto transportVendorDto) {
            return ResponseEntity.ok(transportVendorService.createTransportVendor(transportVendorDto));
        }
